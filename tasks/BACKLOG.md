...
| M9-16 | Branch model: `develop` integrates, `main` needs owner confirmation — rules in every agent entry point | in-flight | — | `CLAUDE.md`, `AGENTS.md`, `GEMINI.md`, `.cursorrules`, `skills/AGENTS.md`, `skills/GEMINI.md`, `skills/.cursorrules`, `ARCHITECTURE.md`, `docs/INDEX.md`, `docs/STATE.md`, `tasks/BACKLOG.md`, `tests/test_docs.py`, `docs/decisions/0008-*`, `docs/decisions/README.md`, `tasks/cards/M9-16-*` |
