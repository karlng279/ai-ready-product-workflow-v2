...
| M9-14 | Draw the as-is Archify diagrams: agent collaboration, end-user adoption, framework internals | in-flight | — | `docs/diagrams/**`, `docs/decisions/0006-diagrams-are-snapshots.md`, `docs/decisions/README.md`, `docs/INDEX.md`, `ARCHITECTURE.md` (1.1 map), `README.md` (tree), `docs/STATE.md`, `tasks/BACKLOG.md`, `tasks/cards/M9-14-as-is-diagrams.md` |
